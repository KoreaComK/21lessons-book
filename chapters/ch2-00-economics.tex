...
\begin{enumerate}
  ...
  \item \nameref{les:12}
  \item \nameref{les:13}
  \item \nameref{les:14}\footnote{Nota do tradutor: O termo \textit{sound money} é quase um trocadilho com o som que uma moeda faz ao cair no chão, mas também passa a ideia de dinheiro saudável.}
\end{enumerate}
\end{samepage}
